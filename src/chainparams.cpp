...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1643740373, // * UNIX timestamp of last checkpoint block
    0,   // * total number of transactions between genesis and last checkpoint
                //   (the tx=... number in the UpdateTip debug.log lines)
    2822220        // * estimated number of transactions per day after checkpoint
};
...
public:
    CMainParams()
    {
        ...
        consensus.nBudgetFeeConfirmations = 5;      // Number of confirmations for the finalization fee
        consensus.nCoinbaseMaturity = 5;
        consensus.nFutureTimeDriftPoW = 7200;
        consensus.nFutureTimeDriftPoS = 180;
        consensus.nMaxMoneyOut = 9999999999 * COIN;
        consensus.nPoolMaxTransactions = 3;
        consensus.nProposalEstablishmentTime = 60 * 60 * 999999999999999999999;    // must be at least a day old to make it into a budget
        consensus.nStakeMinAge = 60 * 60 * 24; // 24h
        consensus.nStakeMinDepth = 10;
        consensus.nStakeMinDepthV2 = 600; //investigate changes v2 stake change
        ...
        consensus.ZC_TimeStart = 5556165178;        // Thu Apr 25 04:06:18 AM +00 2019
